...
function About() {
  ...
  const [showExperienceHapo, setShowExperienceHapo] = useState(false);
  const [showExperienceCapaciti, setShowExperienceCapaciti] = useState(false);
  const [showExperienceTutor, setShowExperienceTutor] = useState(false);
  ...
  return (
    <div className="container mt-5">
        ...
        <li className="education-item">
          ...
          {showHyperionDev && (
            <div className="full-info">
              <ul>
                <li>
                  <strong>Software Engineering Bootcamp (2024):</strong> 
                  Full-stack dev with Python, Flask, Django, GitHub, CV & interview prep, capstone projects.
                </li>
              </ul>
            </div>
          )}
      ...
      <ul className="experience-list">
        {/* Hapo Technology (Latest First) */}
        <li className="experience-item">
          <div
            className="about_list_items"
            onClick={() => setShowExperienceHapo(!showExperienceHapo)}
            style={{ cursor: 'pointer' }}
          >
            <strong>Cloud & Software Developer at Hapo Technology</strong> [July 2025 – Present]
          </div>
          {showExperienceHapo && (
            <div className="full-info">
              <ul>
                <li>Role: <strong>Cloud and Software Development</strong></li>
                <li>Building real-world projects with modern technologies.</li>
                <li>Focus on scalable systems, APIs, and full-stack solutions.</li>
              </ul>
            </div>
          )}
          <br /><br />
        ...
        <li className="experience-item">
          <div
            className="about_list_items"
            onClick={() => setShowExperienceCapaciti(!showExperienceCapaciti)}
            style={{ cursor: 'pointer' }}
          >
            <strong>Cloud Associate at CAPACITI</strong> [Feb 2025 – Present]
          </div>
          {showExperienceCapaciti && (
            <div className="full-info">
              <ul>
        ...
        <li className="experience-item">
          <div
            className="about_list_items"
            onClick={() => setShowExperienceTutor(!showExperienceTutor)}
            style={{ cursor: 'pointer' }}
          >
